...
import HeroGridGlow from "../components/HeroGridGlow";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        ...
        <AnimatedSection>
          <div className="relative overflow-hidden bg-gradient-to-r from-[#0B0F17] via-[#111827] to-[#0B0F17] rounded-3xl p-6 sm:p-10 border border-white/[0.1] shadow-[0_20px_60px_rgba(0,0,0,0.8)]">
            {/* SVG Coordinate Grid & Radial Shader Glow from Pointer AI */}
            <HeroGridGlow />
        ...
        {/* ── Global Search Bar ────────────────────────────────────── */}
        <AnimatedSection delay={0.05} className="relative">
        ...
        {/* ── Pointer AI Bento Feature Showcase ──────────────────────── */}
        <BentoGridShowcase />
        ...
        <AnimatedSection delay={0.05}>
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="grid gap-3.5">
                {news.slice(0, 5).map((item, idx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="p-5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.08] hover:border-[#00D09C]/30 backdrop-blur-xl flex items-start justify-between gap-4 group cursor-pointer transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,208,156,0.08)]"
                  >
            ...
            <section className="space-y-4">
              ...
              <div className="bg-white/[0.02] border border-white/[0.08] rounded-3xl p-6 space-y-4 shadow-xl backdrop-blur-xl">
